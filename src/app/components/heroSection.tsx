        ...
        <div>
            <div className="flex gap-x-[5vw] justify-center items-center pt-[5%]">
                <div className="w-[30%] flex flex-col gap-y-[2vh]">
                    ...
                    <div className="text-lg text-gray-600">Ücretsiz yapay zeka destekli görev yöneticisiyle her şey yerli yerinde: iş hayatınız organize, özel hayatınız rahat. Her günün daha planlı, her anın daha verimli olduğu bir dünyaya adım atın.</div>
